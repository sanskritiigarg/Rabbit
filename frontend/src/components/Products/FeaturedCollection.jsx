...
const FeaturedCollection = () => {
  return (
    <section className="py-16 px-4">
      <div className="container mx-auto flex flex-col-reverse lg:flex-row items-center bg-stitches/12 rounded-3xl">
        {/*Left Content */}
        ...
        <div className="w-full lg:w-1/2">
          <img
            ...
            className="w-full h-[550px] object-cover rounded-t-3xl lg:rounded-tl-none lg:rounded-br-3xl
            "
          />
        </div>
      </div>
