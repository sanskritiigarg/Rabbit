...
const ProductManagement = () => {
  ...
  return (
    <div className='max-w-7xl mx-auto p-6'>
      <h2 className='text-2xl font-b mb-4'>Product Management</h2>
              ...
              products.map((product) => (
                <tr key={product._id} className='border-b hover:bg-gray-50 cursor-pointer'>
                  ...
                  <td className='p-4'>
                    ...
                    Edit</Link>
                    <button className='bg-red-500 text-white px-2 py-0.5 rounded mr-2 hover:bg-red-600' onClick={() => handleDelete(product._id)}>Delete</button>
                  </td>
                </tr>
              ))
            ) : (
