    ...
    <div className="max-w-7xl mx-auto p-6">
      <div className="mb-6 flex flex-col md:flex-row justify-between">
        ...
        <Link
          ...
          className="bg-stitches p-2 rounded text-white hover:bg-stitches/90 text-center mr-4 font-semibold"
        >
          Add New Product +
        </Link>
      </div>
              ...
              products.map((product) => (
                <tr key={product._id} className="border-b hover:bg-gray-50 cursor-pointer">
                  ...
                  <td className="p-4">
                    ...
                    <button
                      className="bg-red-500 text-white px-2 py-0.5 rounded mr-2 hover:bg-red-600"
