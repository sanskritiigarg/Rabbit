    ...
    <div className='max-x-7xl mx-auto p-6'>
      ...
      <div className='overflow-x-auto shadow-md sm:rounded-lg'>
        <table className='min-w-full text-left text-gray-500'>
          ...
          <tbody>
            {users.map((user) => (
              <tr key={user._id} className='border-b hover:bg-gray-50 text-gray-600'>
                ...
                <td className='p-4'>
                  <button onClick={() => handleDeleteUser(user._id)} className='bg-red-500 text-white px-4 py-1.5 rounded hover:bg-red-600'>Delete</button>
                </td>
              </tr>
            ))}
          </tbody>
