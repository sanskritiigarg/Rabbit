      ...
      orderItems: [
        {
          ...
          quantity: 1,
          price: 15,
          image: "https://picsum.photos/200random=1"
        },
        {
          productId: '2',
          name: "Jeans",
      ...
      {!orderDetails? (
        ...
        <div className='p-4 sm:p-6 rounded-lg border'>
          ...
          <div className='flex flex-col sm:flex-row justify-between mb-8'>
            ...
            <div className='flex flex-col items-start sm:itmes-end mt-4 sm:mt-0'>
              <span className={`
                ...
                px-3 py-1 rounded-full text-sm font-medium mb-2`}>
                  {orderDetails.isDelivered ? 'Deliveres' : 'Pending'}
                </span>
            </div>
          </div>
                ...
                {orderDetails.orderItems.map((item) => (
                  <tr key={item.productId} className='border-b'>
                    <td className='py-2 px-4 flex items-center'>
                      <img src={item.name} alt={item.name} className='w-12 h-12 object-cover rounded-lg mr-2' />
                      <Link to={`/products/${item.productId}`} className='hover:underline'>{item.name}</Link>
                    </td>
